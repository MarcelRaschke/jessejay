...
<p class="has-black-color has-text-color">DJ, Jesse Jay, JesseJay, Michael, Fellner, Michael Fellner,
Techno, House, Progressive, Prog-House, Progressive-House, Tech-House, progressive, sexy Musik</p>
<!-- /wp:paragraph →
...
<column name="date">2003-02-28</column>
<column name="event">greenspace and smoked night</column>
<column name="eventURL"></column>
<column name="lineup"></column>
</table>
<table name="evenTable">
<column name="eventID">18</column>
<column name="date">0000-00-00</column>
<column name="event">me myself and i</column>
<column name="eventURL"></column>
<column name="lineup"></column>
</table>
<table name="evenTable">
<column name="eventID">27</column>
<column name="date">2003-05-16</column>
<column name="event">Local Underground on Air!</column>
<column name="eventURL">www.localunderground.ch</column>
<column name="lineup">Jesse Jay, Tino Boss, Frisk, Manic</column>
</table>
<table name="evenTable">
